...
- 작업 시 가장 시간을 많이 뺏기는 습관: {answers.get('q1', '없음')}
- 마감 전 반복하는 비효율적 행동: {answers.get('q2', '없음')}
- 집중이 깨질 때 주로 하는 행동: {answers.get('q3', '없음')}
- 완벽주의 성향이 나타나는 영역: {answers.get('q4', '없음')}
- 작업 전 과도하게 준비하는 것: {answers.get('q5', '없음')}
